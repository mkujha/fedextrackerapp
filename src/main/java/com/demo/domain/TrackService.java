 ...
 * 
 */
@WebServiceClient(name = "TrackService", targetNamespace = "http://demo.com/ws/track/v12", wsdlLocation = "file:/C:/Users/Mjha/Downloads/jaxws-ri-2.2.10/jaxws-ri/bin/TrackingService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName TRACKSERVICE_QNAME = new QName("http://demo.com/ws/track/v12", "TrackService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Mjha/Downloads/jaxws-ri-2.2.10/jaxws-ri/bin/TrackingService.wsdl");
    ...
    public TrackPortType getTrackServicePort() {
        return super.getPort(new QName("http://demo.com/ws/track/v12", "TrackServicePort"), TrackPortType.class);
    }
    ...
    public TrackPortType getTrackServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.com/ws/track/v12", "TrackServicePort"), TrackPortType.class, features);
    }
